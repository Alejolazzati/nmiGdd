...
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('FranciscodeC','FranciscodeC','Deporte favorito','Squash')
...
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('JankoJanoG','JankoJanoG','Gusto musical','Reguuea')
...
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('FacundoFalkoM','FacundoFalkoM','Club favorito','Boca unidos')
...
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('DenisaDaraR','DenisaDaraR','Postre favorito','Danette')
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('HuilenR','HuilenR','Postre favorito','Vainilla')
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('JosemariaJosephR','JosemariaJosephR','Postre favorito','Chocolate')
...
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('RaulRaulinoR','RaulRaulino','Deporte favorito','Beach soccer')
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('DelasnievesS','DelasnievesS','Carrera','Medico')
...
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('DelrosarioT','DelrosarioT','Carrera','Director tecnica')
...
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('DelrosarioV','DelrosarioV','Carrera','Profesora de hockey')
