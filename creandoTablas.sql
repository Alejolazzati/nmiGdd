...
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('FranciscoC','FranciscodeC','Deporte favorito','Squash')
...
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('JankoG','JankoJanoG','Gusto musical','Reguuea')
...
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('FacundoM','FacundoFalkoM','Club favorito','Boca unidos')
...
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('DenisaR','DenisaDaraR','Postre favorito','Danette')
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('HuilenR','HuilenR','Postre favorito','Vainilla')
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('JosemariaR','JosemariaJosephR','Postre favorito','Chocolate')
...
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('RaulR','RaulRaulino','Deporte favorito','Beach soccer')
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('DeS','DelasnievesS','Carrera','Medico')
...
insert into Usuario(Useranme,Contraseña,Pregunta_secreta,Respuesta) values ('DelT','DelrosarioT','Carrera','Director tecnica')
