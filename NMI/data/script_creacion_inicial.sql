...
create procedure NMI.clientesConMasTransferenciasEntreCuentasPropias
@anio char(4), @trimestre int
as
begin 
declare @mesdiadesde char(4)
...
select top 5 c1.Nombre,c1.Apellido from NMI.cliente c1,NMI.cuenta c2,NMI.Transferencias t,NMI.cuenta c3,NMI.cliente c4,NMI.Transacciones tr
where
c1.Id_cliente=c2.Codigo_cliente and c2.Num_cuenta=t.Cod_cuenta_origen and c3.Num_cuenta=t.Cod_cuenta_destino
and c3.Codigo_cliente=c4.Id_cliente and c1.Id_cliente=c4.Id_cliente and t.Cod_transaccion=tr.Id_transaccion
and tr.Fecha between @anio+@mesdiadesde and @anio+@mesdiahasta
group by c1.Nombre,c1.Apellido
order by COUNT(*) desc
end
go
