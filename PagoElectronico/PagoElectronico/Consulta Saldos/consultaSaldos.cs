...
namespace PagoElectronico.Consulta_Saldos
{
    public partial class consultaSaldos : Form
    {
        ...
        public consultaSaldos(String numeroCuenta)
        {
            ...
            reader.Dispose();
            comando.CommandText = "Select * from NMI.ultimos5Depositos(" + cuenta + ")";
            ...
            set = new DataSet();            
            comando.CommandText = "Select * from NMI.ultimos5Retiros(" + cuenta + ")";
            adapter.Fill(set);
            ...
            adapter = new System.Data.SqlClient.SqlDataAdapter(comando);
            set = new DataSet();
            comando.CommandText = "Select * from NMI.ultimas10Transf(" + cuenta + ")";
            adapter.Fill(set);
